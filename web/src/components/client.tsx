...
export const TERMINAL_CARDS: TerminalCardDef[] = [
	...
	},
	{
		...
		lines: [
			...
			"[KDF] Derive: 287ms avg",
			"[KDF] Encrypt: 0.4ms avg",
			"[KDF] Decrypt: 0.3ms avg",
			"[OK] Vault unlocked",
		],
	},
	{
